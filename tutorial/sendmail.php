...
*/    
    ...
    $umessage = $_POST['umessage'];
		...
		$email_to = "<hello@teamily.com>"; //Your Mail Id
		$email_subject = "Customer Contact via courses";
       ...
       $email_message .= "Message: ".clean_string($umessage). "<br><br>";
		...
		echo "Thank You for Contacting Us, Matt will get back to you asap.";
?>